...
\begin{enumerate}
    ...
    \item \textbf{Constraint Satisfaction AI Engine:} A backend algorithm that evaluates multiple requirements (instructor availability, branch capacity) to guarantee valid, conflict-free schedules while prioritizing administrative preferences.
...
Evaluates instructor, room, and time variables as a formal CSP to ensure valid conflict-free schedules. &
